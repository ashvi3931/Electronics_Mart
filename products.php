    ...
    <div class="py-2 border-bottom ml-3">
        ...
        <?php
               ...
               while($row_data=mysqli_fetch_assoc($res_cat))
               {
                   ...
                   <input type='checkbox' class='common_selector category' value = '$cat_id'>
        ...
        <div class="scroll">
            <?php
                ...
                while($row_data=mysqli_fetch_assoc($res_br))
                {
                    ...
                    echo "<div class='form-group'>
                    <input type='checkbox' class='common_selector brand' value = '$brand_id'>
...
<section id="sidebar">
    ...
    <div class="py-2 border-bottom ml-3 mt-3">
        <h6 class="font-weight-bold">Brands</h6>
        <div id="orange"><span class="fa fa-minus"></span></div>
        <div class="scroll">
        <form>
