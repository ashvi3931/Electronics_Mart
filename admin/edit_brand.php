...
{
    $edit=$_GET['edit_brand'];
    $sel="select * from `brands` where brand_id=$edit";
...
if(isset($_POST['update']))
{
    ...
    $update="update `brands` set brand_name='$brand_name' where brand_id=$edit";
...
<header class="app-header fixed-top">
  ...
  <button type="submit" class="btn app-btn-secondary" name="update">Update</button>
</form> 
    <!-- Javascript -->
