  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="categories.php?view_categories">
                                <span class="nav-icon">
...
<li class="nav-item">
                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <!--//col-->
                                <div class="col-auto">
                                <button type="submit" class="btn app-btn-secondary"><a href="ins_cat.php">Add Categories</a></button>
                                </div>
  ...
  <tbody>
    ...
    $no=0;
     ...
     $num_per_page=4;
     $start_from=($page-1)*4;
     $sel_cat="select * from `categories` limit $start_from,$num_per_page";
    ...
    <tr class="text-center">
      ...
      <td><a href='edit_cat.php?edit_category=<?php echo $category_id ?>' class='text-light'><i class='fa-solid fa-pen-to-square'></i></a></td>
      <td><a href='delete_cat.php?delete_category=<?php echo $category_id ?>' type="button"><i class='fa-solid fa-trash'></i></a></td>
...
if($page>1)
{
    echo "<a href='categories.php?page=".($page-1)."' class='btn btn-outline-dark'>Previous</a>";
    
}
 for($i=1;$i<$total_pages1;$i++)
 {
    echo "<a href='categories.php?page=".$i."' class='btn btn-outline-dark'>".$i."</a>";
 }
 if($i>$page)
{
    echo "<a href='categories.php?page=".($page+1)."' class='btn btn-outline-dark'>Next</a>";
