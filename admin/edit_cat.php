...
{
    $edit=$_GET['edit_category'];
    $sel="select * from `categories` where category_id=$edit";
...
if(isset($_POST['update_category']))
{
    ...
    $update="update `categories` set category_name='$cat_name' where category_id=$edit";
...
<header class="app-header fixed-top">
                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <!--//col-->
                                <div class="col-auto">
                                <button type="submit" class="btn app-btn-secondary">Add Categories</button>
                                </div>
  ...
  <button type="submit" class="btn app-btn-secondary" name="update_category">Update</button>
</form> 
    <!-- Javascript -->
