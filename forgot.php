...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/APPLIANCES_MART/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
$mail->Port = 587; 
$mail->Username = "twinkss288@gmail.com";   //Enter your username/emailid
$mail->Password = "rkeemmnauztdyacq";   //Enter your password
$mail->FromName = "Appliances mart Admin";
