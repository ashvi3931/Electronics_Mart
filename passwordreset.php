...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($con,"update user set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully <a href="user_login.php">Click here</a> to login';
    }
    else
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($con,"select email from user where email='$email'");
