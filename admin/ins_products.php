...
if(isset($_POST['submit']))
{
    ...
    $prod_desc=$_POST['description'];
     $prod_keywords=$_POST['keyword'];
     $category_id=$_POST['prod_cat'];
     $brand_id=$_POST['prod_br'];
     ...
     if($prod_name=='' or $prod_desc=='' or $prod_keywords=='' or $category_id=='' or $brand_id=='' or $prod_price=='' or $img1=='')
     {
        echo "<script>alert('Please fill every details')</script>";
        exit();
     }
     else
     {
        move_uploaded_file($tmp_img1,"./product_images/$img1");
        $ins_prod="insert into `products` (prod_name,prod_desc,prod_keywords,category_id,brand_id,p_img1,prod_price,date,prod_status) values ('$prod_name','$prod_desc','$prod_keywords','$category_id','$brand_id','$img1','$prod_price',NOW(),'$prod_status')";
        $res=mysqli_query($con,$ins_prod);
        if($res)
        {
...
<header class="app-header fixed-top">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
        ...
        <div class="form-outline mb-4 w-50 m-auto">
                <select name="prod_cat" class="form-select">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                <select name="prod_br" class="form-select">
